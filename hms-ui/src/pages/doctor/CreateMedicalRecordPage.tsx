    ...
    if (!patientId) {
        return (
            <div style={{ padding: 40, textAlign: "center" }}>
                No patient selected. Go back and use "Create Record" from an
                appointment.
            </div>
        );
    }
            ...
            <Card title="Record Details" style={{ borderRadius: 8 }}>
                ...
                >
                    ...
                    >
                        <TextArea
                            rows={5}
                            placeholder="Describe the patient's condition, symptoms, diagnosis..."
                            maxLength={2000}
                            showCount
                        />
                    </Form.Item>
                    <Form.Item name="advice" label="Doctor Advice">
                        <TextArea
                            rows={4}
                            placeholder="Treatment plan, medication notes, follow-up instructions..."
                            maxLength={2000}
                            showCount
                        />
                    </Form.Item>
