...
export default function EmployeeListPage() {
    ...
    const { data: deptData } = useQuery({
        ...
        queryFn: () =>
            getDepartments({ page: 0, size: 100 }).then((r) => r.data),
    });
    ...
    const handleEditSubmit = (values: Record<string, unknown>) => {
        ...
        if (values.hireDate)
            payload.hireDate = dayjs(values.hireDate as string).format(
                "YYYY-MM-DD",
            );
        ...
        <div>
            ...
            <Card style={{ borderRadius: 8 }}>
                <Space style={{ marginBottom: 16 }} wrap>
                    ...
                    >
                        <Select.Option value={ROLE_NAMES.DOCTOR}>
                            Doctor
                        </Select.Option>
                        <Select.Option value={ROLE_NAMES.RECEPTIONIST}>
                            Receptionist
                        </Select.Option>
                        <Select.Option value={ROLE_NAMES.PHARMACIST}>
                            Pharmacist
                        </Select.Option>
                        <Select.Option value={ROLE_NAMES.CASHIER}>
                            Cashier
                        </Select.Option>
                        <Select.Option value={ROLE_NAMES.ADMIN}>
                            Admin
                        </Select.Option>
                    </Select>
                    <Select
