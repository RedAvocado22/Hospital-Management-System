      ...
      <Card style={{ borderRadius: 8 }}>
        ...
        <Form layout="vertical" onFinish={onFinish} size="large">
          <Row gutter={32}>
            ...
            <Col span={12} style={{ borderRight: '1px solid #EEF1F5', paddingRight: 32 }}>
              ...
              <Form.Item label="Address" name="address" rules={[{ required: true }, { min: 5, message: 'At least 5 characters' }]}>
                <Input.TextArea placeholder="Home address" rows={3} />
              </Form.Item>
            </Col>

            {/* Right — Account + Employment Information */}
            <Col span={12} style={{ paddingLeft: 16 }}>
              <Title level={5} style={{ marginBottom: 16, paddingBottom: 12, borderBottom: '1px solid #EEF1F5' }}>Account Information</Title>
          ...
          <Form.Item style={{ marginTop: 24, borderTop: '1px solid #EEF1F5', paddingTop: 16 }}>
            <Space>
