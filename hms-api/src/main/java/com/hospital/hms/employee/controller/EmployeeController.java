...
public class EmployeeController {
    ...
    public ApiResponse<Void> createEmployee(@Valid @RequestBody CreateEmployeeRequest request) {
        createEmployeeService.execute(request);
        return ApiResponse.success(null, "Employee created successfully", HttpStatus.CREATED.value());
    }
}